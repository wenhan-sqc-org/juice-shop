...
describe('/rest/user/whoami', () => {
  ...
  it('GET who-am-i request returns nothing on expired auth token', () => {
    ...
    const payload = ''
    const signature = 'FL0kkcInY5sDMGKeLHfEOYDTQd3BjR6_mK7Tcm_RH6iCLotTSRRoRxHpLkbtIQKqBFIt14J4BpLapkzG7ppRWcEley5nego-4iFOmXQvCBz5ISS3HdtM0saJnOe0agyVUen3huFp4F2UCth_y2ScjMn_4AgW66cz8NSFPRVpC8g'
    return frisby.get(`${REST_URL}/user/whoami`, { headers: { Authorization: `${header}.${payload}.${signature}` } })
      .expect('status', 200)
      .expect('header', 'content-type', /application\/json/)
      .expect('json', {
        user: {}
