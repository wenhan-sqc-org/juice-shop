...
const privateKey = process.env.RSA_PRIVATE_KEY ?? defaultPrivateKey
...
const defaultHmacSecret = 'pa4qacea4VK9t9nGv7yZtwmj'
const hmacSecret = process.env.HMAC_SECRET ?? defaultHmacSecret
